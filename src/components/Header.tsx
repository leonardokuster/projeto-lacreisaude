...
export default function Header() {
    ...
    return (
        ...
        <StyledToolbar>
            ...
            >
                <StyledMenuItem onClick={handleCloseMenu}>
                    <Link href="/" passHref data-testid="login-paciente" style={{ textDecoration: 'none', color: 'inherit' }}>
                        <div style={{ padding: '8px 16px' }}>
                            <PersonOutlineOutlinedIcon /> Paciente
                        </div>
                    </Link>
                ...
                <Divider />
                <StyledMenuItem onClick={handleCloseMenu}>
                    <Link href="/" passHref data-testid="login-profissional" style={{ textDecoration: 'none', color: 'inherit' }}>
                        <div style={{ padding: '8px 16px' }}>
                            <MedicalServicesOutlinedIcon /> Profissional
                        </div>
                    </Link>
